      ...
      <>
        ...
        <main className="main">
          ...
          {shortLinks.map((item: any) => {
            return (
              <div className=" w-full grid sm:grid-cols-3 grid-cols-1 gap-4 mt-4" key={item.id}>
                <div className="sm:mx-12 mx-5 max-w-sm rounded-2xl overflow-hidden shadow-lg bg-slate-700 hover:scale-105 ">
