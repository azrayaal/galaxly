      ...
      <nav id="header" className="fixed w-full z-30 top-0 text-white">
        <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
          ...
          <div className="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent  p-4 lg:p-0 z-20" id="nav-content">
            ...
            <Link href="/loginpage">
              <button className="mx-auto lg:mx-0 font-semibold rounded-xl mt-2 lg:mt-0 py-2 px-8 shadow focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out bg-gray-400 bg-transparent border-2 border-gray-50 text-gray-50">
                create new link
              </button>
            </Link>
          </div>
